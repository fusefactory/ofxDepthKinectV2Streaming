...
KinectObjectTracker::KinectObjectTracker(KinectDevice *kinect) {
    ...
    colorImage.allocate(kinect->DEPTH_WIDTH, kinect->DEPTH_HEIGHT);
    grayImage.allocate(kinect->DEPTH_WIDTH, kinect->DEPTH_HEIGHT);
    
    fbo.allocate(kinect->DEPTH_WIDTH, kinect->DEPTH_HEIGHT, GL_RGBA);
